    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tbl_Tutelado", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultadoData = table.Column<byte[]>(type: "varbinary(max)", unicode: false, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tbl_Exame_Tbl_Tutelado_TuteladoId",
                        column: x => x.TuteladoId,
                        principalTable: "Tbl_Tutelado",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TuteladosLembretes_Tbl_Tutelado_TuteladoId",
                        column: x => x.TuteladoId,
                        principalTable: "Tbl_Tutelado",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
